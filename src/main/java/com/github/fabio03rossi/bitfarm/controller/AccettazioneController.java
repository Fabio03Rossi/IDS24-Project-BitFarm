...
public class AccettazioneController {
    ...
    @RequestMapping(value = "/" + PATH + "/getAllRichiesteAccettazioni", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/" + PATH + "/accettaArticolo/{id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/" + PATH + "/accettaEvento/{id}", method = RequestMethod.PUT)
